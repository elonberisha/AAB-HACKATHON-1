...
('sundimi', 'collection', 'Rule of law material copy', '{"key":"rule_of_law_materials_copy","value":{"eyebrow_sq":"Materiale ligjore","title_sq":"Kushtetuta dhe ligjet themelore për sundimin e ligjit.","sub_sq":"Këtu janë aktet bazë që qytetarët duhet t’i kenë afër kur lexojnë për gjykata, procedura, administratë, dogana dhe trafik.","constitution_title_sq":"Kushtetuta e Republikës së Kosovës","fundamental_title_sq":"Ligjet themelore","catalog_title_sq":"Katalogu i plotë i materialeve"}}'::jsonb, 30, true),
('sundimi', 'collection', 'Rule of law action buttons', '{"key":"rule_of_law_actions","items":[{"label_sq":"Kushtetuta e Republikës së Kosovës","href":"#kushtetuta","variant":"dark"},{"label_sq":"Ligjet themelore","href":"#ligjet-themelore","variant":"light"}]}'::jsonb, 31, true),
